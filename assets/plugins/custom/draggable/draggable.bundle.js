  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      class c extends i.default {
        constructor(e) {
          super(e),
            (this.options = o({}, u, this.getOptions())),
        ...
        attach() {
          this.draggable.on("sortable:sort", this[l]),
            this.draggable.on("sortable:sorted", this[a]);
        }
        detach() {
          this.draggable.off("sortable:sort", this[l]),
        ...
        [l]({ dragEvent: e }) {
          const { sourceContainer: t } = e,
            r = this.draggable.getDraggableElementsForContainer(t);
        ...
        [a]({ oldIndex: e, newIndex: t }) {
          ...
          e > t
            ...
            : ((n = e + 1), (o = t), (s = -1));
          for (let e = n; e <= o; e++) {
            const t = this.lastElements[e],
              n = this.lastElements[e + s];
            r.push({ from: t, to: n });
          }
            ...
            (this.lastAnimationFrame = requestAnimationFrame(() => {
              r.forEach((e) =>
                (function (
                  ...
                  const o = e.domEl,
                    s = e.offsetLeft - t.offsetLeft,
                    i = e.offsetTop - t.offsetTop;
                  (o.style.pointerEvents = "none"),
                    (o.style.transform = `translate3d(${s}px, ${i}px, 0)`),
                    requestAnimationFrame(() => {
                      o.addEventListener("transitionend", d),
                        (o.style.transition = `transform ${r}ms ${n}`),
                        (o.style.transform = "");
                    });
                })(e, this.options)
              );
      ...
      function d(e) {
        (e.target.style.transition = ""),
          ...
          e.target.removeEventListener("transitionend", d);
      }
      t.default = c;
    },
    function (e, t, r) {
    ...
    function (e, t, r) {
      ...
      class u extends i.default {
        constructor(e) {
          super(e),
            (this.options = o({}, l, this.getOptions())),
            (this.lastAnimationFrame = null),
            (this[a] = this[a].bind(this));
        }
        attach() {
    ...
    function (e, t, r) {
      ...
      class g extends i.default {
        constructor(e) {
          super(e),
            (this.options = o({}, h, this.getOptions())),
            (this.lastWidth = 0),
            (this.lastHeight = 0),
            (this.mirror = null),
            (this[l] = this[l].bind(this)),
        ...
        attach() {
          this.draggable
            .on("mirror:created", this[l])
            .on("drag:over", this[c])
            .on("drag:over:container", this[c]);
        }
        detach() {
          this.draggable
            .off("mirror:created", this[l])
            .off("mirror:destroy", this[u])
            .off("drag:over", this[c])
            .off("drag:over:container", this[c]);
        }
        getOptions() {
    ...
    function (e, t, r) {
      ...
      class d extends s.default {
        ...
        [l](e) {
          ...
          (this.currentAnimationFrame = requestAnimationFrame(this[c](t))),
        ...
        [c](e) {
          return () => {
            ...
            this.currentlyCollidingElement = (0, i.closest)(e, (e) =>
              t.includes(e)
            );
          };
        }
    ...
    function (e, t, r) {
      ...
      const h = {
        "sortable:sorted": function ({ dragEvent: e }) {
          const t =
            e.source.textContent.trim() || e.source.id || "sortable element";
          if (e.over) {
            const r =
              e.over.textContent.trim() || e.over.id || "sortable element";
      ...
      class g extends i.default {
        constructor(e = [], t = {}) {
          super(
            e,
            o({}, t, { announcements: o({}, h, t.announcements || {}) })
          ),
        ...
        [u](e) {
          ...
          if (!i) return;
          const { oldContainer: l, newContainer: u } = i,
    ...
    function (e, t, r) {
      ...
      (t.SortableStartEvent = a),
        (a.type = "sortable:start"),
        (a.cancelable = !0);
      class l extends i {
        get currentIndex() {
      ...
      (t.SortableSortEvent = l),
        (l.type = "sortable:sort"),
        (l.cancelable = !0);
      class u extends i {
        get oldIndex() {
    ...
    function (e, t, r) {
      ...
      const d = {
        "swappabled:swapped": function ({ dragEvent: e, swappedElement: t }) {
          return `Swapped ${
            e.source.textContent.trim() || e.source.id || "swappable element"
          } with ${t.textContent.trim() || t.id || "swappable element"}`;
        },
      };
      class h extends i.default {
        constructor(e = [], t = {}) {
          super(
            e,
            o({}, t, { announcements: o({}, d, t.announcements || {}) })
          ),
            (this.lastOver = null),
            (this[l] = this[l].bind(this)),
            (this[u] = this[u].bind(this)),
    ...
    function (e, t, r) {
      ...
      class a extends i {}
      (t.SwappableStartEvent = a),
        (a.type = "swappable:start"),
        (a.cancelable = !0);
      class l extends i {
        get over() {
          return this.data.over;
      ...
      (t.SwappableSwapEvent = l),
        (l.type = "swappable:swap"),
        (l.cancelable = !0);
      class u extends i {
        get swappedElement() {
    ...
    function (e, t, r) {
      ...
      const v = {
          "droppable:dropped": function ({ dragEvent: e, dropzone: t }) {
            return `Dropped ${
              e.source.textContent.trim() || e.source.id || "draggable element"
            } into ${t.textContent.trim() || t.id || "droppable element"}`;
          },
          "droppable:returned": function ({ dragEvent: e, dropzone: t }) {
            return `Returned ${
              e.source.textContent.trim() || e.source.id || "draggable element"
            } from ${t.textContent.trim() || t.id || "droppable element"}`;
          },
        },
        m = {
      ...
      class y extends a.default {
        constructor(e = [], t = {}) {
          super(
            ...
            (this[c] = this[c].bind(this)),
            (this[d] = this[d].bind(this)),
            this.on("drag:start", this[u])
              .on("drag:move", this[c])
              .on("drag:stop", this[d]);
        }
        destroy() {
          super.destroy(),
            this.off("drag:start", this[u])
              .off("drag:move", this[c])
              .off("drag:stop", this[d]);
        }
        [u](e) {
          if (e.canceled()) return;
          ...
          if ((this.trigger(r), r.canceled())) e.cancel();
            ...
            for (const e of this.dropzones)
              e.classList.contains(
                this.getClassNameFor("droppable:occupied")
              ) ||
                e.classList.add(...this.getClassNamesFor("droppable:active"));
          }
        }
        [c](e) {
          if (e.canceled()) return;
          ...
          this[h](e, t)
            ...
            : (t && t !== this.initialDropzone) ||
              !this.lastDropzone ||
              (this[g](e), (this.lastDropzone = null));
        }
        [d](e) {
          ...
          for (const e of this.dropzones)
            e.classList.remove(...this.getClassNamesFor("droppable:active"));
          this.lastDropzone &&
    ...
    function (e, t, r) {
      ...
      (t.DroppableStartEvent = a),
        (a.type = "droppable:start"),
        (a.cancelable = !0);
      class l extends i {
        get dropzone() {
          return this.data.dropzone;
      ...
      (t.DroppableDroppedEvent = l),
        (l.type = "droppable:dropped"),
        (l.cancelable = !0);
      class u extends i {
        get dropzone() {
          return this.data.dropzone;
      ...
      (t.DroppableReturnedEvent = u),
        (u.type = "droppable:returned"),
        (u.cancelable = !0);
      class c extends i {
        get dropzone() {
          return this.data.dropzone;
      ...
      (t.DroppableStopEvent = c),
        (c.type = "droppable:stop"),
        (c.cancelable = !0);
    },
    function (e, t, r) {
      "use strict";
    ...
    function (e, t, r) {
      ...
      class y {
        constructor(e = [document.body], t = {}) {
          ...
          (this.options = o({}, b, t, {
            ...
            document.addEventListener("drag:start", this[h], !0),
            document.addEventListener("drag:move", this[g], !0),
            document.addEventListener("drag:stop", this[f], !0),
            document.addEventListener("drag:pressure", this[p], !0);
          const r = Object.values(y.Plugins).filter(
              (e) => !this.options.exclude.plugins.includes(e)
            ),
            n = Object.values(y.Sensors).filter(
              (e) => !this.options.exclude.sensors.includes(e)
            );
        ...
        destroy() {
          document.removeEventListener("drag:start", this[h], !0),
            document.removeEventListener("drag:move", this[g], !0),
            document.removeEventListener("drag:stop", this[f], !0),
            document.removeEventListener("drag:pressure", this[p], !0);
        ...
        [h](e) {
          ...
          if ((this.trigger(i), (this.dragging = !i.canceled()), i.canceled()))
            return (
        ...
        [g](e) {
          ...
          const i = (0, s.closest)(t.target, this.containers),
            a = t.overContainer || i,
      ...
      (t.default = y),
        ...
        (y.Sensors = {
          MouseSensor: u.MouseSensor,
          TouchSensor: u.TouchSensor,
        });
    },
    function (e, t, r) {
      "use strict";
        ...
        attach() {
          for (const e of this.containers)
            e.addEventListener("webkitmouseforcewillbegin", this[a], !1),
              ...
              e.addEventListener("mousedown", this[u], !0),
              e.addEventListener("webkitmouseforcechanged", this[c], !1);
        ...
        detach() {
          for (const e of this.containers)
            e.removeEventListener("webkitmouseforcewillbegin", this[a], !1),
              ...
              e.removeEventListener("mousedown", this[u], !0),
              e.removeEventListener("webkitmouseforcechanged", this[c], !1);
          document.removeEventListener("mousemove", this[d]),
            document.removeEventListener("mouseup", this[h]);
        }
        [a](e) {
    ...
    function (e, t, r) {
      ...
      class p extends i.default {
        ...
        [c](e) {
          ...
          const t = document.elementFromPoint(e.clientX, e.clientY);
          if (
            ((this.currentContainer = (0, o.closest)(
              e.target,
              this.containers
            )),
        ...
        [l](e) {
          ...
          t && ((t.draggable = !1), (this.nativeDraggableElement = t)),
            ...
            document.addEventListener("dragend", this[h], !1),
            document.addEventListener("drop", this[g], !1);
        ...
        [f]() {
          clearTimeout(this.mouseDownTimeout),
            ...
            document.removeEventListener("dragend", this[h], !1),
            document.removeEventListener("drop", this[g], !1),
    ...
    function (e, t, r) {
      ...
      class f extends i.default {
        ...
        [l](e) {
          ...
          if (!t) return;
          const { distance: r = 0 } = this.options,
            { delay: n } = this,
            { pageX: s, pageY: i } = (0, o.touchCoords)(e);
          Object.assign(this, { pageX: s, pageY: i }),
        ...
        [d]() {
          ...
          this.trigger(this.currentContainer, n),
            (this.dragging = !n.canceled()),
            this.dragging && document.addEventListener("touchmove", this[c]),
            (g = this.dragging);
        }
        [h](e) {
          const { distance: t } = this.options,
          ...
          Object.assign(this, i),
            ...
            a < n.touch
              ...
              : l >= t &&
                (document.removeEventListener("touchmove", this[h]), this[d]());
        }
        [c](e) {
          if (!this.dragging) return;
        ...
        [u](e) {
          if (
            ...
            document.removeEventListener("touchmove", this[h]),
            this.currentContainer &&
              this.currentContainer.removeEventListener("contextmenu", p),
            !this.dragging)
          )
            return;
    ...
    function (e, t, r) {
      ...
      class f extends i.default {
        ...
        [u](e) {
          ...
          const { delay: r } = this,
            { pageX: n, pageY: s } = e;
          Object.assign(this, { pageX: n, pageY: s }),
        ...
        [h]() {
          ...
          this.trigger(this.currentContainer, r),
            (this.dragging = !r.canceled()),
            this.dragging &&
              (document.addEventListener("contextmenu", this[l], !0),
        ...
        [g](e) {
          ...
          if (
            (Object.assign(this, { pageX: t, pageY: r }),
            !this.currentContainer)
          )
            return;
          const a = Date.now() - this.onMouseDownAt,
            l = (0, o.distance)(s.pageX, s.pageY, t, r) || 0;
          clearTimeout(this.mouseDownTimeout),
            a < i.mouse
              ? document.removeEventListener("mousemove", this[g])
              : l >= n &&
                (document.removeEventListener("mousemove", this[g]), this[h]());
        }
        [c](e) {
          if (!this.dragging) return;
          const t = document.elementFromPoint(e.clientX, e.clientY),
        ...
        [d](e) {
          ...
          this.trigger(this.currentContainer, r),
            document.removeEventListener("contextmenu", this[l], !0),
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = function (e, t) {
          ...
          const r = t,
            ...
            u = Boolean(t instanceof NodeList || t instanceof Array),
            c = Boolean(t instanceof HTMLElement);
          let d = e;
          do {
            if (
              ((d = d.correspondingUseElement || d.correspondingElement || d),
              (h = d)
                ? a
                  ? n.call(h, r)
                  : u
      ...
      class g extends i.default {
        ...
        getScrollableElement(e) {
          return this.hasDefinedScrollableElements()
            ? (0, a.closest)(e, this.options.scrollableElements) ||
                    ...
                    (e) =>
                      (!r ||
                        !(function (e) {
                          return (
                            "static" ===
                            getComputedStyle(e).getPropertyValue("position")
                          );
                        })(e)) &&
                      (function (e) {
                        const t = /(auto|scroll)/,
        ...
        [d]() {
          ...
          if (i === document.body || i === document.documentElement || o) {
            ...
            l < t ? (s.scrollTop -= e) : r - l < t && (s.scrollTop += e),
              a < t ? (s.scrollLeft -= e) : n - a < t && (s.scrollLeft += e);
          } else {
            const { offsetHeight: n, offsetWidth: o } = i;
            r.top + n - l < t
              ? (i.scrollTop += e)
              : l - r.top < t && (i.scrollTop -= e),
              r.left + o - a < t
                ? (i.scrollLeft += e)
                : a - r.left < t && (i.scrollLeft -= e);
          }
          this.scrollAnimationFrame = requestAnimationFrame(this[d]);
        }
      }
    ...
    function (e, t, r) {
      ...
      (t.MirrorDestroyEvent = d),
        (d.type = "mirror:destroy"),
        (d.cancelable = !0);
    },
    function (e, t, r) {
      "use strict";
    ...
    function (e, t, r) {
      ...
      const u = (t.onDragStart = Symbol("onDragStart")),
      ...
      class m extends i.default {
        constructor(e) {
          super(e),
            (this.options = o({}, v, this.getOptions())),
        ...
        attach() {
          this.draggable
            .on("drag:start", this[u])
            .on("drag:move", this[c])
            .on("drag:stop", this[d])
            .on("mirror:created", this[h])
            .on("mirror:move", this[g]);
        }
        detach() {
          this.draggable
            .off("drag:start", this[u])
            .off("drag:move", this[c])
            .off("drag:stop", this[d])
            .off("mirror:created", this[h])
            .off("mirror:move", this[g]);
        }
        getOptions() {
        ...
        [u](e) {
          if (e.canceled()) return;
          "ontouchstart" in window &&
            document.addEventListener("scroll", this[f], !0),
            (this.initialScrollOffset = {
              x: window.scrollX,
              y: window.scrollY,
            });
        ...
        [c](e) {
          ...
          if (this.options.thresholdX || this.options.thresholdY) {
            ...
            if (
              (Math.abs(e - o.clientX) < this.options.thresholdX
                ? (s = !1)
                : (this.lastMirrorMovedClient.x = o.clientX),
              Math.abs(t - o.clientY) < this.options.thresholdY
                ? (i = !1)
                : (this.lastMirrorMovedClient.y = o.clientY),
              !s && !i)
            )
              return;
          }
        ...
        [d](e) {
          if (
            ("ontouchstart" in window &&
              document.removeEventListener("scroll", this[f], !0),
          ...
          this.draggable.trigger(o),
            o.canceled() || this.mirror.parentNode.removeChild(this.mirror);
        }
        [f]() {
          this.scrollOffset = {
          ...
          return Promise.resolve(s)
            ...
            .then((e) => {
              ...
              return (
                ...
                (this.lastMovedX = r),
                (this.lastMovedY = n),
                o({ mirrorOffset: t, initialX: r, initialY: n }, s)
              );
            });
        }
        [g](e) {
          ...
          return Promise.resolve(t)
            .then(_({ raf: !0 }))
            .then((e) => {
              let { lastMovedX: t, lastMovedY: r } = e,
                n = l(e, ["lastMovedX", "lastMovedY"]);
              return (
                (this.lastMovedX = t),
                (this.lastMovedY = r),
                o({ lastMovedX: t, lastMovedY: r }, n)
              );
            });
        }
        [p](e) {
      ...
      function y(e) {
        let { sensorEvent: t, sourceRect: r, options: n } = e,
          s = l(e, ["sensorEvent", "sourceRect", "options"]);
        return M((e) => {
          const i =
        ...
        return M((e) => {
          ...
          (t.style.display = null),
            ...
            n.constrainDimensions &&
              ((t.style.height = i), (t.style.width = a)),
            e(o({ mirror: t, source: r, options: n }, s));
        });
      }
      function O(e) {
        let { mirror: t, mirrorClasses: r } = e,
          n = l(e, ["mirror", "mirrorClasses"]);
        return M((e) => {
      ...
      function _({ withFrame: e = !1, initial: t = !1 } = {}) {
        return (r) => {
          ...
          return M(
            (e) => {
              const r = o(
                { mirror: n, sensorEvent: s, mirrorOffset: i, options: d },
                v
              );
              if (i) {
                const e = h
                    ? Math.round(
                        (s.clientX - i.left - c.x) / (d.thresholdX || 1)
                      ) * (d.thresholdX || 1)
                    : Math.round(f),
                  o = g
                    ? Math.round(
                        (s.clientY - i.top - c.y) / (d.thresholdY || 1)
                      ) * (d.thresholdY || 1)
                    : Math.round(p);
                (d.xAxis && d.yAxis) || t
                  ...
                  : d.yAxis &&
                    !d.xAxis &&
                    (n.style.transform = `translate3d(${u}px, ${o}px, 0)`),
    ...
    function (e, t, r) {
      ...
      class c extends i.default {
        ...
        attach() {
          this.draggable
            .on("draggable:initialize", this[a])
            .on("draggable:destroy", this[l]);
        }
        detach() {
          this.draggable
            .off("draggable:initialize", this[a])
            .off("draggable:destroy", this[l]),
            this[l]();
        }
        getOptions() {
        ...
        [a]() {
          requestAnimationFrame(() => {
            this.getElements().forEach((e) =>
              (function (e) {
                Boolean(!e.getAttribute("tabindex") && -1 === e.tabIndex) &&
                  (d.push(e), (e.tabIndex = 0));
              })(e)
            );
          });
        }
    ...
    function (e, t, r) {
      ...
      class h extends i.default {
        constructor(e) {
          super(e),
            (this.options = o({}, d, this.getOptions())),
        ...
        [u](e) {
          ...
          t && "string" == typeof t && this[c](t),
            t && "function" == typeof t && this[c](t(e));
        }
        [c](e) {
          !(function (e, { expire: t }) {
    ...
    return (function (e) {
      ...
      function (e, t, r) {
        ...
        (r(2).inspectSource = function (e) {
          ...
          (e.exports = function (e, t, r, a) {
            ...
            l && (s(r, "name") || o(r, "name", t)),
              e[t] !== r &&
                (l &&
                  (s(r, i) || o(r, i, e[t] ? "" + e[t] : u.join(String(t)))),
                e === n
                  ? (e[t] = r)
                  : a
                  ? e[t]
      ...
      function (e, t, r) {
        ...
        e.exports = function (e, t, r, v, m, b, y) {
          ...
          if (
            (L &&
              (S = c(L.call(new e()))) !== Object.prototype &&
              S.next &&
              (u(S, M, !0), n || "function" == typeof S[d] || i(S, d, p)),
            C &&
              D &&
              D.name !== f &&
              ((w = !0),
            ...
            if (
              ((E = { values: C ? x : _(f), keys: b ? x : _(g), entries: j }),
              y)
            )
              for (O in E) O in P || s(P, O, E[O]);
      ...
      function (e, t, r) {
        ...
        class g extends i.default {
          ...
          index(e) {
            return this.getSortableElementsForContainer(e.parentNode).indexOf(
              e
            );
          }
          getSortableElementsForContainer(e) {
      ...
      function (e, t, r) {
        ...
        class y {
          ...
          [h](e) {
            ...
            if (
              (this.trigger(i), (this.dragging = !i.canceled()), i.canceled())
            )
              return (
                this.source.parentNode.removeChild(this.source),
                void (this.originalSource.style.display = null)
      ...
      function (e, t, r) {
        ...
        e.exports = function (e) {
          return function (t) {
            for (
              var r, i = o(t), a = n(i), l = a.length, u = 0, c = [];
              l > u;

            )
              s.call(i, (r = a[u++])) && c.push(e ? [r, i[r]] : i[r]);
            return c;
          };
        };
      },
      ...
      function (e, t, r) {
        ...
        e.exports =
          ...
          r(23)(function () {
            ...
            ? function (e, t) {
                for (
                  var r = i(e), l = arguments.length, u = 1, c = o.f, d = s.f;
                  l > u;
          ...
          function (e, t, r, d, h) {
            ...
            if (s(m)) {
              for (g = a(e.length); g > y; y++)
                if (
                  (v = t ? b(i((f = e[y]))[0], f[1]) : b(e[y])) === u ||
                  v === c
                )
                  return v;
            } else
              for (p = m.call(e); !(f = p.next()).done; )
                if ((v = o(p, b, f.value, t)) === u || v === c) return v;
          }).BREAK = u),
          (t.RETURN = c);
      },
      function (e, t) {
      ...
      function (e, t, r) {
        for (
          ...
          var v,
            ...
            y = i[m],
            E = y && y.prototype;
          if (E && (E[c] || a(E, c, h), E[d] || a(E, d, m), (l[m] = h), b))
            for (v in n) E[v] || s(E, v, n[v], !0);
        }
      },
      function (e, t, r) {
        var n = r(12),
      ...
      function (e, t, r) {
        ...
        e.exports = r(11)
          ...
          : function (e, t) {
              o(e);
              for (var r, i = s(t), a = i.length, l = 0; a > l; )
                n.f(e, (r = i[l++]), t[r]);
              return e;
            };
      },
      ...
      function (e, t, r) {
        ...
        e.exports = function (e) {
          var t = n(e),
            r = o.f;
          if (r)
            for (var i, a = r(e), l = s.f, u = 0; a.length > u; )
      ...
      function (e, t, r) {
        ...
        var n = r(1),
          ...
          V = function (e, t) {
            b(e);
            for (var r, n = v((t = E(t))), o = 0, s = n.length; s > o; )
              W(e, (r = n[o++]), t[r]);
            return e;
          },
          G = function (e) {
            ...
            return (
              !(this === I && o(z, e) && !o(k, e)) &&
              (!(t || !o(this, e) || !o(z, e) || (o(this, F) && this[F][e])) ||
                t)
            );
          },
          K = function (e, t) {
            if (((e = E(e)), (t = O(t, !0)), e !== I || !o(z, t) || o(k, t))) {
              var r = D(e, t);
              return (
                !r || !o(z, t) || (o(e, F) && e[F][t]) || (r.enumerable = !0), r
              );
            }
          },
          J = function (e) {
            for (var t, r = j(E(e)), n = [], s = 0; r.length > s; )
              o(z, (t = r[s++])) || t == F || t == l || n.push(t);
            return n;
          },
          Z = function (e) {
            for (
              var t, r = e === I, n = j(r ? k : E(e)), s = [], i = 0;
              n.length > i;

            )
              !o(z, (t = n[i++])) || (r && !o(I, t)) || s.push(z[t]);
            return s;
          };
        q ||
          ((L = function () {
        ...
        i(i.S + i.F * !q, "Symbol", {
          ...
          L.prototype[T] || r(10)(L.prototype, T, L.prototype.valueOf),
          d(L, "Symbol"),
          d(Math, "Math", !0),
          d(n.JSON, "JSON", !0);
      },
