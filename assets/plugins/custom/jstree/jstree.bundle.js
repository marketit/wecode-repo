    ...
    !c &&
      ...
      (e.jstree.core.prototype = {
            ...
            var a = null,
              ...
              d = function (e, t) {
                ...
                if (n.length && n[0].id !== t && n[0].parent !== t) {
                  ...
                  a = { cnt: u, mod: f, sel: m, par: d, dpc: l, add: h };
                } else {
                  for (r = 0, s = n.length; r < s; r++)
        ...
        redraw_node: function (t, i, r, s) {
          ...
          if (
            (g.length && (t.childNodes[1].className = "jstree-anchor " + g),
            ...
            this.settings.core.force_text
              ? t.childNodes[1].appendChild(u.createTextNode(a.text))
              : (t.childNodes[1].innerHTML += a.text),
            i && a.children.length && (a.state.opened || s) && a.state.loaded)
          ) {
            for (
              (_ = u.createElement("UL")).setAttribute("role", "group"),
          ...
          if ((c && t.appendChild(c), !r)) {
            ...
            m ||
              ((m = u.createElement("UL")).setAttribute("role", "group"),
        ...
        move_node: function (i, r, s, a, n, o, d) {
          ...
          if (
            ...
            (f =
              ...
              this._id !== u._id),
            (_ =
              u && u._id && h && u._model.data[h] && u._model.data[h].children
          ...
          if (i.parent === g.id) {
            ...
            for (
              ...
              for (
                p = [],
                  k = 0,
                  b = (y = u._model.data[i.parents[v]].children_d).length;
                k < b;
                k++
              )
            ...
            for (
              u._model.data[h].children = e.vakata.array_remove_item(
              ...
              this._model.data[g.parents[v]].children_d =
                this._model.data[g.parents[v]].children_d.concat(m);
            ...
            for (
              p[s] = i.id,
                ...
                g.children_d = g.children_d.concat(i.children_d),
                i.parent = g.id,
            ...
            (h !== e.jstree.root && g.id !== e.jstree.root) ||
              (this._model.force_full_redraw = !0),
              this._model.force_full_redraw ||
                (this._node_changed(h), this._node_changed(g.id)),
              o || this.redraw();
          }
          return (
            a && a.call(this, i, g, s),
        ...
        copy_node: function (i, r, s, a, n, o, d) {
          ...
          for (
            ...
            this._model.data[m.parents[g]].children_d =
              this._model.data[m.parents[g]].children_d.concat(h);
              ...
              this.element
                .on(
                  ...
                  function (t, i) {
                    ...
                    if (-1 !== g.indexOf("down"))
                      if (l.state[u ? "selected" : "checked"]) {
                        for (s = 0, a = h.length; s < a; s++)
                          c[h[s]].state[u ? "selected" : "checked"] = !0;
                        this._data[u ? "core" : "checkbox"].selected =
                          this._data[u ? "core" : "checkbox"].selected.concat(
                            h
                          );
                      } else
                        for (s = 0, a = h.length; s < a; s++)
                          if (c[h[s]].state[u ? "selected" : "checked"]) {
                            for (
                    ...
                    if (-1 !== g.indexOf("up")) {
                      ...
                      for (
                        ...
                        for (l = c[_[n]]; l && l.id !== e.jstree.root; ) {
                          ...
                          if (r !== a) break;
                          (l.state[u ? "selected" : "checked"] = !0),
                            this._data[u ? "core" : "checkbox"].selected.push(
                              l.id
                            ),
                            (d = this.get_node(l, !0)) &&
                              d.length &&
                              d
                                ...
                                .children(".jstree-anchor")
                                .addClass(
                                  u ? "jstree-clicked" : "jstree-checked"
                                ),
                ...
                .on(
                  ...
                  function (t, i) {
                    var r,
                      ...
                      _ = {},
                      g = this._data[h ? "core" : "checkbox"].selected;
                    for (r = 0, s = g.length; r < s; r++) _[g[r]] = !0;
                    if (-1 !== l.indexOf("down")) {
                      var u = this._cascade_new_checked_state(o.id, !0),
                        f = o.children_d.concat(o.id);
                      for (r = 0, s = f.length; r < s; r++)
                        u.indexOf(f[r]) > -1 ? (_[f[r]] = !0) : delete _[f[r]];
                    }
                    if (-1 !== l.indexOf("up"))
                    ...
                    for (r in ((g = []), _)) _.hasOwnProperty(r) && g.push(r);
                    this._data[h ? "core" : "checkbox"].selected = g;
                  }.bind(this)
                )
                .on(
                  this.settings.checkbox.tie_selection
          ...
          show: function (r, s, a) {
            ...
            r &&
              ...
              i.items.length &&
                ...
                (h = o.width()),
                (_ = o.height()),
                (g = e(window).width() + e(window).scrollLeft()),
            ...
            if (
              ...
              return (
                ...
                i.helper &&
                  ...
                  a && _ + 25 > a && (_ = a - 50),
                  o && g + i.helper_w > o && (g = o - (i.helper_w + 2)),
                  i.helper.css({ left: g + "px", top: _ + "px" })),
                e.vakata.dnd._trigger("move", t),
                !1
              );
            }
              ...
              e.each(_[a || e.jstree.root].children_d, function (e, t) {
                ...
                r.text &&
                  ...
                  ((l.search_callback && l.search_callback.call(this, i, r)) ||
                    (!l.search_callback && g.search(r.text).isMatch)) &&
        ...
        (this.check = function (t, i, s, a, n) {
          ...
          for (o = 0, d = s.children.length; o < d; o++)
            (c = u[s.children[o]].text),
              _ || (c = c.toLowerCase()),
              g && (c = c.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")),
              h.push(c);
          switch (
            (_ || (l = l.toLowerCase()),
            g && (l = l.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")),
            t)
          ) {
            case "delete_node":
              return !0;
