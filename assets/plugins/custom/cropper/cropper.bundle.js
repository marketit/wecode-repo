...
!(function (t, e) {
  ...
  var s = "undefined" != typeof window && void 0 !== window.document,
    ...
    l =
      ...
      "ontouchstart" in c.document.documentElement,
    d = !!s && "PointerEvent" in c,
    p = "cropper",
    m = "all",
    u = "crop",
    g = "move",
    ...
    j = "cropstart",
    I = "dblclick",
    P = d ? "pointerdown" : l ? "touchstart" : "mousedown",
    U = d ? "pointermove" : l ? "touchmove" : "mousemove",
    q = d ? "pointerup pointercancel" : l ? "touchend touchcancel" : "mouseup",
    $ = "ready",
    Q = "resize",
    K = "wheel",
    Z = "zoom",
    G = "image/jpeg",
    V = /^e|w|s|n|se|sw|ne|nw|all|crop|move|zoom$/,
    F = /^data:/,
  ...
  function dt(t, e) {
    return (
      t &&
        st(e) &&
        (Array.isArray(t) || it(t.length)
          ? lt(t).forEach(function (i, a) {
              e.call(t, i, a, t);
            })
          : ot(t) &&
  ...
  function ut(t) {
    ...
    return mt.test(t) ? Math.round(t * e) / e : t;
  }
  ...
  var yt = /([a-z\d])([A-Z])/g;
  function xt(t) {
    return t.replace(yt, "$1-$2").toLowerCase();
  }
  function Mt(t, e) {
    return ot(t[e])
      ? t[e]
      : t.dataset
      ? t.dataset[e]
      : t.getAttribute("data-".concat(xt(e)));
  }
  function Ct(t, e, i) {
    ot(i)
      ? (t[e] = i)
      : t.dataset
      ? (t.dataset[e] = i)
      : t.setAttribute("data-".concat(xt(e)), i);
  }
  var Dt = /\s\s*/,
    Bt = (function () {
      var t = !1;
      if (s) {
        ...
        c.addEventListener("test", i, a), c.removeEventListener("test", i, a);
      }
      return t;
    })();
  function kt(t, e, i) {
  ...
  function Nt(t) {
    ...
    return (
      null !== e &&
      (e[1] !== Wt.protocol || e[2] !== Wt.hostname || e[3] !== Wt.port)
    );
  }
  function Lt(t) {
  ...
  function zt(t) {
    var e = t.rotate,
      ...
      o = t.translateY,
      r = [];
    it(n) && 0 !== n && r.push("translateX(".concat(n, "px)")),
      it(o) && 0 !== o && r.push("translateY(".concat(o, "px)")),
      it(e) && 0 !== e && r.push("rotate(".concat(e, "deg)")),
      it(i) && 1 !== i && r.push("scaleX(".concat(i, ")")),
      it(a) && 1 !== a && r.push("scaleY(".concat(a, ")"));
  ...
  function Rt(t, e, i, a) {
    var n = e.aspectRatio,
      ...
      N = H.getContext("2d"),
      L = Xt({ aspectRatio: u, width: D, height: k }),
      z = Xt({ aspectRatio: u, width: T, height: W }, "cover"),
      Y = Math.min(L.width, Math.max(z.width, g)),
      X = Math.min(L.height, Math.max(z.height, f)),
      R = Xt({ aspectRatio: n, width: D, height: k }),
      S = Xt({ aspectRatio: n, width: T, height: W }, "cover"),
      A = Math.min(R.width, Math.max(S.width, o)),
      j = Math.min(R.height, Math.max(S.height, h)),
      I = [-A / 2, -j / 2, A, j];
    return (
      (H.width = ut(Y)),
      (H.height = ut(X)),
      ...
      if (n) {
        ...
        if (
          ...
          (function (t, e, i) {
            var a = "";
            i += e;
            for (var n = e; n < i; n += 1) a += St(t.getUint8(n));
            return a;
          })(i, n + 4, 4)
        ) {
          var c = i.getUint16(s);
  ...
  var It = {
      ...
      initContainer: function () {
        ...
        vt(a, O), wt(t, O);
        var r = {
          width: Math.max(i.offsetWidth, n >= 0 ? n : 200),
          height: Math.max(i.offsetHeight, o >= 0 ? o : 100),
        };
        (this.containerData = r),
          ft(a, { width: r.width, height: r.height }),
          vt(t, O),
          wt(a, O);
      },
      initCanvas: function () {
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          ft(
            ...
            pt(
              ...
              zt({ translateX: i.left, translateY: i.top })
            )
          ),
          this.renderImage(t),
      ...
      renderImage: function (t) {
        ...
        pt(i, {
          ...
          ft(
            ...
            pt(
              { width: i.width, height: i.height },
              zt(pt({ translateX: i.left, translateY: i.top }, i))
            )
          ),
          t && this.output();
      },
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          t.movable &&
            ...
            Ct(
              this.face,
              N,
              i.width >= e.width && i.height >= e.height ? g : m
            ),
          ft(
            this.cropBox,
            pt(
      ...
      output: function () {
        this.preview(), Tt(this.element, R, this.getData());
      },
    },
    Pt = {
      ...
      resetPreview: function () {
        dt(this.previews, function (t) {
          var e = Mt(t, L);
          ft(t, { width: e.width, height: e.height }),
            (t.innerHTML = e.html),
            (function (t, e) {
              if (ot(t[e]))
                try {
              ...
              else t.removeAttribute("data-".concat(xt(e)));
            })(t, L);
        });
      },
      preview: function () {
        ...
        this.cropped &&
          ...
          (ft(
            ...
            pt(
              { width: o, height: r },
              zt(pt({ translateX: -h, translateY: -s }, t))
            )
          ),
          dt(this.previews, function (e) {
            ...
            a && (p = n * (m = c / a)),
              n && p > l && ((d = a * (m = l / n)), (p = l)),
              ft(e, { width: d, height: p }),
              ft(
                e.getElementsByTagName("img")[0],
                pt(
                  { width: o * m, height: r * m },
                  zt(pt({ translateX: -h * m, translateY: -s * m }, t))
                )
              );
          }));
      },
    ...
    Ut = {
      bind: function () {
        var t = this.element,
          e = this.options,
          i = this.cropper;
        st(e.cropstart) && Ot(t, j, e.cropstart),
          st(e.cropmove) && Ot(t, A, e.cropmove),
          st(e.cropend) && Ot(t, S, e.cropend),
          st(e.crop) && Ot(t, R, e.crop),
          st(e.zoom) && Ot(t, Z, e.zoom),
          Ot(i, P, (this.onCropStart = this.cropStart.bind(this))),
          e.zoomable &&
            e.zoomOnWheel &&
            Ot(i, K, (this.onWheel = this.wheel.bind(this)), {
              passive: !1,
              capture: !0,
            }),
          e.toggleDragModeOnDblclick &&
            Ot(i, I, (this.onDblclick = this.dblclick.bind(this))),
          Ot(t.ownerDocument, U, (this.onCropMove = this.cropMove.bind(this))),
          Ot(t.ownerDocument, q, (this.onCropEnd = this.cropEnd.bind(this))),
          e.responsive &&
            Ot(window, Q, (this.onResize = this.resize.bind(this)));
      },
      unbind: function () {
        var t = this.element,
          e = this.options,
          i = this.cropper;
        st(e.cropstart) && kt(t, j, e.cropstart),
          st(e.cropmove) && kt(t, A, e.cropmove),
          st(e.cropend) && kt(t, S, e.cropend),
          st(e.crop) && kt(t, R, e.crop),
          st(e.zoom) && kt(t, Z, e.zoom),
          kt(i, P, this.onCropStart),
          e.zoomable &&
            e.zoomOnWheel &&
            kt(i, K, this.onWheel, { passive: !1, capture: !0 }),
          e.toggleDragModeOnDblclick && kt(i, I, this.onDblclick),
          kt(t.ownerDocument, U, this.onCropMove),
          kt(t.ownerDocument, q, this.onCropEnd),
          e.responsive && kt(window, Q, this.onResize);
      },
    },
    qt = {
      resize: function () {
      ...
      cropStart: function (t) {
        ...
        if (
          ...
          t.changedTouches
            ...
            : (o[t.pointerId || 0] = Yt(t)),
            (a =
              Object.keys(o).length > 1 && n.zoomable && n.zoomOnTouch
                ? f
                : Mt(t.target, N)),
            V.test(a) &&
              !1 !== Tt(this.element, j, { originalEvent: t, action: a }) &&
              (t.preventDefault(),
              (this.action = a),
              (this.cropping = !1),
              a === u && ((this.cropping = !0), vt(this.dragBox, W)));
        }
      },
      cropMove: function (t) {
        var e = this.action;
        if (!this.disabled && e) {
          var i = this.pointers;
          t.preventDefault(),
            !1 !== Tt(this.element, A, { originalEvent: t, action: e }) &&
              (t.changedTouches
                ? dt(t.changedTouches, function (t) {
                    pt(i[t.identifier] || {}, Yt(t, !0));
                  })
                : pt(i[t.pointerId || 0] || {}, Yt(t, !0)),
              this.change(t));
        }
      },
      cropEnd: function (t) {
        if (!this.disabled) {
          ...
          t.changedTouches
            ...
            e &&
              ...
              this.cropping &&
                ((this.cropping = !1),
                bt(this.dragBox, W, this.cropped && this.options.modal)),
              Tt(this.element, S, { originalEvent: t, action: e }));
        }
      },
    },
    $t = {
      change: function (t) {
        var i,
          ...
          N = o.height,
          L = !0;
        !c && t.shiftKey && (c = p && B ? p / B : 1),
          this.limited &&
            ((E = r.minLeft),
            (W = r.minTop),
            (H = E + Math.min(o.width, n.width, n.left + n.width)),
            (N = W + Math.min(o.height, n.height, n.top + n.height)));
        var z = h[Object.keys(h)[0]],
          Y = { x: z.endX - z.startX, y: z.endY - z.startY },
          X = function (t) {
            switch (t) {
              case v:
                k + Y.x > H && (Y.x = H - k);
        ...
        switch (s) {
          case m:
            ...
            break;
          case v:
            if (Y.x >= 0 && (k >= H || (c && (d <= W || T >= N)))) {
              L = !1;
              break;
            }
            X(v),
              (p += Y.x) < 0 && ((s = w), (l -= p = -p)),
              c && ((B = p / c), (d += (r.height - B) / 2));
            break;
          case y:
            if (Y.y <= 0 && (d <= W || (c && (l <= E || k >= H)))) {
              L = !1;
              break;
            }
            X(y),
              ...
              (d += Y.y),
              B < 0 && ((s = b), (d -= B = -B)),
              c && ((p = B * c), (l += (r.width - p) / 2));
            break;
          case w:
            if (Y.x <= 0 && (l <= E || (c && (d <= W || T >= N)))) {
              L = !1;
              break;
            }
            X(w),
          ...
          case M:
            if (c) {
              ...
              X(y), (B -= Y.y), (d += Y.y), (p = B * c), (l += r.width - p);
            } else
              X(y),
                X(w),
                Y.x <= 0
    ...
    Qt = {
      crop: function () {
        return (
          !this.ready ||
            ...
            ((this.cropped = !0),
            this.limitCropBox(!0, !0),
            this.options.modal && vt(this.dragBox, W),
            wt(this.cropBox, O),
      ...
      reset: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.imageData = pt({}, this.initialImageData)),
            (this.canvasData = pt({}, this.initialCanvasData)),
            (this.cropBoxData = pt({}, this.initialCropBoxData)),
            this.renderCanvas(),
            this.cropped && this.renderCropBox()),
          this
        );
      ...
      clear: function () {
        return (
          this.cropped &&
            !this.disabled &&
            (pt(this.cropBoxData, { left: 0, top: 0, width: 0, height: 0 }),
            (this.cropped = !1),
            this.renderCropBox(),
            this.limitCanvas(!0, !0),
            this.renderCanvas(),
      ...
      enable: function () {
        return (
          this.ready &&
            this.disabled &&
            ((this.disabled = !1), wt(this.cropper, k)),
          this
        );
      },
      disable: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.disabled = !0), vt(this.cropper, k)),
          this
        );
      },
      destroy: function () {
      ...
      zoomTo: function (t, e, i) {
        ...
        if (
          ...
          if (
            !1 ===
            Tt(this.element, Z, { ratio: t, oldRatio: o / h, originalEvent: i })
          )
            return this;
          if (i) {
            var d = this.pointers,
            ...
            (n.left -= (c - o) * ((m.pageX - p.left - n.left) / o)),
              (n.top -= (l - r) * ((m.pageY - p.top - n.top) / r));
          } else
            ht(e) && it(e.x) && it(e.y)
      ...
      setData: function (t) {
        var e = this.options,
          ...
          a = this.canvasData,
          n = {};
        if (this.ready && !this.disabled && ht(t)) {
          var o = !1;
          e.rotatable &&
            it(t.rotate) &&
            t.rotate !== i.rotate &&
          ...
          it(t.x) && (n.left = t.x * r + a.left),
            it(t.y) && (n.top = t.y * r + a.top),
            it(t.width) && (n.width = t.width * r),
            it(t.height) && (n.height = t.height * r),
            this.setCropBoxData(n);
        }
        return this;
      },
      getContainerData: function () {
        return this.ready ? pt({}, this.containerData) : {};
      },
      getImageData: function () {
        return this.sized ? pt({}, this.imageData) : {};
      },
      ...
      setCanvasData: function (t) {
        ...
        return (
          this.ready &&
            !this.disabled &&
            ht(t) &&
            (it(t.left) && (e.left = t.left),
            it(t.top) && (e.top = t.top),
            it(t.width)
      ...
      setCropBoxData: function (t) {
        ...
        return (
          this.ready &&
            ...
            !this.disabled &&
            ht(t) &&
            (it(t.left) && (a.left = t.left),
            it(t.top) && (a.top = t.top),
            it(t.width) &&
              t.width !== a.width &&
              ((e = !0), (a.width = t.width)),
            it(t.height) &&
      ...
      getCroppedCanvas: function () {
        ...
        var e = this.canvasData,
          i = Rt(this.image, this.imageData, e, t);
        ...
        var l = h / s,
          ...
          u = m.width,
          g = m.height;
        (u = Math.min(d.width, Math.max(p.width, u))),
      ...
      setDragMode: function (t) {
        ...
        if (this.ready && !this.disabled) {
          ...
          (t = n || o ? t : X),
            ...
            bt(i, B, n),
            bt(i, H, o),
            e.cropBoxMovable || (Ct(a, N, t), bt(a, B, n), bt(a, H, o));
        }
        return this;
      },
    },
                  ...
                  if (F.test(t))
                    J.test(t)
                      ? this.read(
                          ...
                          dt((h = new Uint8Array(r)), function (t, e) {
                            h[e] = o.charCodeAt(e);
                          }),
                          r)
                        )
                    ...
                    (this.reloading = !0),
                      ...
                      (s.onprogress = function () {
                        s.getResponseHeader("content-type") !== G && s.abort();
                      }),
                      (s.onload = function () {
                        e.read(s.response);
                      }),
              ...
              if (a > 1) {
                this.url = (function (t, e) {
                  for (var i = [], a = new Uint8Array(t); a.length > 0; )
                    i.push(St.apply(null, lt(a.subarray(0, 8192)))),
                      (a = a.subarray(8192));
              ...
              var i =
                ...
                a = function (e, i) {
                  pt(t.imageData, {
                    ...
                    (t.initialImageData = pt({}, t.imageData)),
                    (t.sizing = !1),
                    (t.sized = !0),
                    t.build();
                };
          ...
          },
          {
            ...
            value: function () {
              if (this.sized && !this.ready) {
                ...
                var o = n.querySelector(".".concat(p, "-container")),
                  r = o.querySelector(".".concat(p, "-canvas")),
                  h = o.querySelector(".".concat(p, "-drag-box")),
                  s = o.querySelector(".".concat(p, "-crop-box")),
                  c = s.querySelector(".".concat(p, "-face"));
                (this.container = a),
                  (this.cropper = o),
                  (this.canvas = r),
                  (this.dragBox = h),
                  ...
                  vt(s, O),
                  e.guides ||
                    vt(s.getElementsByClassName("".concat(p, "-dashed")), O),
                  e.center ||
                    vt(s.getElementsByClassName("".concat(p, "-center")), O),
                  e.background && vt(o, "".concat(p, "-bg")),
                  e.highlight || vt(c, E),
                  e.cropBoxMovable && (vt(c, H), Ct(c, N, m)),
                  e.cropBoxResizable ||
                    (vt(s.getElementsByClassName("".concat(p, "-line")), O),
                    vt(s.getElementsByClassName("".concat(p, "-point")), O)),
                  this.render(),
                  (this.ready = !0),
                  this.setDragMode(e.dragMode),
                  e.autoCrop && this.crop(),
                  this.setData(e.data),
                  st(e.ready) && Ot(t, $, e.ready, { once: !0 }),
                  Tt(t, $);
              }
            },
          },
  ...
  return pt(Zt.prototype, It, Pt, Ut, qt, $t, Qt), Zt;
});
